/*
  Написать следующий скрипт:
    ...
    - По окончанию ввода, если массив не пустой, вывести alert с текстом 
    `Общая сумма чисел равна ${сумма}`
      
  🔔 PS: Делать проверку того, что пользователь ввел именно число,
   а не произвольный набор  символов, не обязательно. 
      Если хотите, в случае некорректного ввода покажите alert с текстом 
      'Было введено не число, попробуйте еще раз', при этом результат prompt записывать 
      в массив чисел не нужно, после чего снова пользователю предлагается 
...
do {
  ...
  if (pass === null) {
    alert('Press "cancel" button');
  } else if (!password.includes(pass)) {
...
// Дан массив с элементами 2, 5, 9, 15, 0, 4. С помощью цикла for и оператора
//  if выведите на экран столбец тех элементов массива, которые больше 3-х, но меньше 10.
// const arr = [2,5,9,15,0,4, 3]
// let num = 0;
...
// let qwerty = words.length;
// let price = 10;

// let summ = qwerty * price
...
// let users;
// do{
//   users = prompt('ввести число больше 100');
//   if(Number(users) < 100){
...
// let question = confirm(`Введите любое число ${numbers.length }!Давайте сыграем?`);
// if (question) {
//   let name = prompt('Введите имя!');
//   let userInput = prompt(`Введите номер ${min} до ${max}`);
//   if (numbers.includes(Number(userInput))) {
//     alert(`${name} 'Поздравляем, Вы угадали! ${userInput} number`);
//   } else {
//     alert(`${name} Сожалеем, Вы не угадали`);
//   }
// } else {
//   alert(`Щасливо ${name}!`);
// }
